 ...
 *     });
    ...
    function $CompileProvider($provide, $$sanitizeUriProvider) {
         ...
         * @description
         * Retrieves or overrides the default regular expression that is used for whitelisting of safe
         * urls during imgs[src] sanitization.
         *
         * The sanitization is a security measure aimed at prevent XSS attacks via html links.
         *
         * Any url about to be assigned to imgs[src] via data-binding is first normalized and turned into
            ...
            function($injector,   $interpolate,   $exceptionHandler,   $http,   $templateCache,   $parse,
                ...
                Attributes.prototype = {
                    ...
                    $set: function(key, value, writeAttr, attrName) {
                        ...
                        // sanitize a[href] and imgs[src] values
 ...
 * them} or {@link ng.$sce#trustAsResourceUrl wrap it} into a trusted value.
     ...
     *
     * Additionally, `a[href]` and `imgs[src]` automatically sanitize their URLs and do not pass them
     ...
     * | `$sce.URL`          | For URLs that are safe to follow as links.  Currently unused (`<a href=` and `<imgs src=` sanitize their urls and don't constitute an SCE context. |
...
// service.
     ...
     * http://stackoverflow.com/a/472729)  However, setting imgs[src] does normalize the URL.
     * Unfortunately, setting imgs[src] to something like "javascript:foo" on IE throws an exception.
 ...
 *     });
     ...
     * ```html
     * <imgs src="http://www.gravatar.com/avatar/{{hash}}"/>
     * ```
     *
     * The correct way to write it:
     * ```html
     * <imgs ng-src="http://www.gravatar.com/avatar/{{hash}}"/>
     * ```
     *
     * @element IMG
     ...
     * The buggy way to write it:
     * ```html
     * <imgs srcset="http://www.gravatar.com/avatar/{{hash}} 2x"/>
     * ```
     *
     * The correct way to write it:
     * ```html
     * <imgs ng-srcset="http://www.gravatar.com/avatar/{{hash}} 2x"/>
     * ```
     *
     * @element IMG
